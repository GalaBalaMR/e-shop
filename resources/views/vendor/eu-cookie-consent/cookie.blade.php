<div>
    ...
    <input type="checkbox" id="{{ $cookieName }}" name="{{ $cookieName }}"
        class="eu-cookie-consent-category-{{ $categoryName }} eu-cookie-consent-cookie" value="1"
        @if (!isset($cookie['forced']) && \the42coders\EuCookieConsent\EuCookieConsent::canIUse($cookieName)) checked="checked" @endif
        @if (isset($cookie['forced'])) checked="checked" disabled="disabled" @endif }}>
